...
export default function HubungiKamiPage() {
  ...
  const handleMailto = () => {
    ...
    window.location.href = `mailto:bagobago955@gmail.com?subject=${subject}&body=${body}`;
  };
            ...
            {[
              {
                ...
                title: 'Email', value: 'bagobago955@gmail.com',
                sub: 'Respons dalam 1-2 hari kerja.'
              },
              {
                icon: Github, color: 'text-foreground', bg: 'bg-slate-50 border-slate-200',
                title: 'GitHub', value: 'https://github.com/nouvalrizqy05-ui/arkon.git',
