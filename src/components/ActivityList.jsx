...
const STATUS_MAP = {
  pending: { label: 'Belum Dikerjakan', color: 'bg-gray-100 text-gray-600', icon: AlertCircle },
    ...
    <div className="h-full overflow-y-auto bg-gray-50 custom-scrollbar">
      <div className="max-w-4xl mx-auto p-8">
        ...
        <div className="mb-8">
          ...
          <p className="text-sm text-gray-500 mt-1">Tugas yang diberikan Dosen di room ini.</p>
        </div>

        {/* Filter Tabs */}
        <div className="flex items-center gap-2 mb-6 bg-white rounded-xl p-1.5 border border-gray-200 shadow-sm w-fit">
          {[
            { id: 'all', label: 'Semua' },
                    ...
                    <div className="flex items-start gap-4 flex-1">
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        {activity.description && (
                          <p className="text-sm text-gray-500 mt-1.5 line-clamp-2">{activity.description}</p>
                        )}
