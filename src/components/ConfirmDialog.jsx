    ...
    <AnimatePresence>
      ...
      >
        <motion.div
          ...
          className="bg-white dark:bg-white border border-border dark:border-border rounded-[2.5rem] p-8 max-w-md w-full shadow-2xl"
        >
          ...
          <div className="flex gap-3 justify-end">
            <button
              onClick={onCancel}
              className="px-6 py-3 rounded-2xl border border-border text-secondary hover:bg-muted transition-colors font-bold text-sm"
            >
              Batal
            </button>
            <button
              onClick={onConfirm}
              className={`px-6 py-3 rounded-2xl font-bold text-foreground transition-colors text-sm shadow-lg ${
