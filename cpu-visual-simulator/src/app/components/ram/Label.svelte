	...
	{#if isSelected}
		<input
			...
			class="
				...
				font-mono
			"
			style="background: rgba(16, 185, 129, 0.1); color: #10b981; border-color: rgba(16, 185, 129, 0.3); box-shadow: inset 0 0 10px rgba(16, 185, 129, 0.05);"
		/>
	{:else if label}
		<div
			on:input={formatInput}
			...
			class="
				...
				text-emerald-light
			"
			style="background: rgba(16, 185, 129, 0.08); border-color: rgba(16, 185, 129, 0.2); box-shadow: inset 0 0 10px rgba(16, 185, 129, 0.05);"
		>
			{label} :
		</div>
	{:else}
		...
		>
			<svg class="w-6 h-6 transition-colors" style="fill: rgba(16, 185, 129, 0.3);">
